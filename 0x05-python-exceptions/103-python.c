...
/**
 * print_python_float - func that prints info about python float
...
/**
 * print_python_bytes - func that prints info about python bytes
 * @p: address of pyobject struct
 */
...
/**
 * print_python_list - func that prints info about python lists
 * @p: address of pyobject struct
 */
